...
list.addTest('should support subscribing and sending a suback (MQTT-3.8.4-1, MQTT-3.8.4-2)', function(done) {
  var m = f.m();
...
list.addTest('should support subscribing to multiple topics (MQTT-3.9.3-1, MQTT-3.8.4-5)', function(done) {
  var m = f.m();
  f.rawClient(function(client, opts){
    client.connect(opts);
    client.on('suback', function(packet) {
...
list.addTest('should support unsubscribing (MQTT-3.10.3-4)', function(done) {
  var m = f.m();
  var t = f.t();
  f.rawClient(function(client, opts){
    client.connect(opts);
...
list.addTest('should support unsubscribing even if there is no subscription (MQTT-3.10.3-5)', function(done) {
  var m = f.m();
  var t = f.t();
  f.rawClient(function(client, opts){
    client.connect(opts);
...
list.addTest('should unsubscribe for real (MQTT-3.10.3-2)', function(done) {
  var t = f.t();
  var p = f.p();
...
list.addTest('should unsubscribe from topics with multiple wildcards', function(done) {
  f.client(function(client){
    client.on('message', function() {
      client.end();
      throw new Error('this message should not have been published');
...
list.addTest('should support subscribing to # wildcard', function(done) {
...
list.addTest('should support subscribing to topics with multiple wildcards', function(done) {
  var d = f.countDone(2, done);
  f.client(function(client1){
    var p = f.p();
    client1.on('message', function(topic, payload) {
...
list.addTest('should support subscribing to QoS 1', function(done) {
  var t = f.t();
  var m = f.m();
  f.rawClient(function(client, opts){
    client.connect(opts);
...
list.addTest('should support subscribing with overlapping topics and receiving message only once', function(done) {
  var d = f.countDone(2, done);
  var p = f.p();
  var called = 0;
